...
def train(train_loader, model, optimizer, scaler, epoch, save_path, writer):
    """
    train function
    """
...
def val(test_loader, model, epoch, save_path, writer):
    ...
    with torch.no_grad():
        ...
        for i in range(test_loader.size):
            ...
            res = F.upsample(res, size=gt.shape[1:], mode='bilinear', align_corners=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str,
                        default='./Checkpoints/PreyNetwPVTZoom/',
    ...
    fh = logging.FileHandler(os.path.join("./Logs/Train", 'PreyNet.txt'))
    ...
    try:
        for epoch in range(1, opt.epoch):
            ...
            train(train_loader, model, optimizer, scaler, epoch, save_path, writer)
