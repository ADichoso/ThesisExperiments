...
def make_dataset(root):
    ...
    return [(os.path.join(image_path,img_name +'.png'),os.path.join(depth_path,img_name.replace("left", "depth")+'.png'),os.path.join(gt_path,img_name+'.png')) for img_name in img_list]   
